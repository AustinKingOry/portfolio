...
const Hero = () => {
    ...
    return (
        <section id="intro" className="max-sm:px-6 mt-20 py-16 max-w-7xl mx-auto">
            <div className="flex flex-col-reverse md:flex-row gap-4 px-4">
                <div className="flex-col justify-start items-start md:w-2/4 gap-6 inline-flex">
                    ...
                    <div className="w-fit">
                        <span className="text-gray-700 text-lg font-normal font-['Work Sans'] leading-normal">I&rsquo;m a </span>
                        <span className="text-[#132138] text-lg font-medium font-['Work Sans'] leading-normal">Tech Entrepreneur</span>
                        <span className="text-[#132138] text-lg font-medium font-['Work Sans'] leading-normal">, Software Engineer</span>
                        <span className="text-gray-700 text-lg font-normal font-['Work Sans'] leading-normal"> and </span>
                        <span className="text-[#132138] text-lg font-medium font-['Work Sans'] leading-normal">Tech Enthusiast</span>
                        <span className="text-gray-700 text-lg font-normal font-['Work Sans'] leading-normal"> based in Kenya with a passion for solving world problems through technology. I love working on backend systems. I’m exploring data science, machine learning, mobile development, DevOps, and embedded systems, and I’m also into startups.</span>
                    </div>
