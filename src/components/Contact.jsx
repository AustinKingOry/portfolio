    ...
    const sendEmail = async (e) =>{
        ...
        try {
            ...
            if(serviceId && templateId && publicKey){
                ...
                console.warning("Please provide valid email service credentials.");
                return;
            }
    ...
    <section id="contact" className="py-16 max-w-7xl mx-auto max-sm:mx-6 max-lg:px-6 max-sm:px-0">
        <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 rounded-lg p-8 gap-8 max-sm:px-4 overflow-hidden bg-white" data-aos="fade-up">
                ...
                <form action="" onSubmit={sendEmail} method="post" className="bg-gray-50 p-6 rounded-lg shadow md:mt-8">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <textarea name="message" id="message" value={formData.message} onChange={handleChange} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required></textarea>
                    ...
                    <button type="submit" disabled={sending} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{sending?"Sending...":"Send"}</button>
                </form>
            </div>
        </div>
        ...
        {sent ?
        <div className="fixed w-screen max-w-[85vw] bottom-0">
            <div id="toast-success" className="float-end flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-md dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div className="ms-3 text-sm font-normal">Your message has been sent successfully. I will be getting in touch with you shortly.</div>
                <button type="button" onClick={()=>{setSent(false)}} className="ms-auto -mx-1.5 -my-1.5 bg-white ;text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-success" aria-label="Close">
